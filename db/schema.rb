...
ActiveRecord::Schema.define(version: 2021_10_06_013342) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "part_messages", force: :cascade do |t|
    t.text "content"
    t.string "subject"
    ...
    t.index ["part_id"], name: "index_part_messages_on_part_id"
    t.index ["user_id"], name: "index_part_messages_on_user_id"
  end
  ...
  add_foreign_key "part_messages", "parts"
  add_foreign_key "part_messages", "users"
